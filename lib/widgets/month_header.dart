  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> dateWidgets = [
      ...
      Row(
        ...
        children: [Text(widget.currentDate.year, style: headerStyle)],
      ),
    ...
    List<Widget> scriptureWidgets = [
      ...
      Container(
        ...
        child: Center(
          child: FilledButton(
            child: Text(AppLocalizations.of(context)!.clickHereToReadMore),
            // Row(
            //   mainAxisAlignment: MainAxisAlignment.center,
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          if (numItems - i != 1) const Divider(thickness: 1, height: 60),
        ],
      ),
    );
  }
